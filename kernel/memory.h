...
#define Virt_To_2M_Page(kaddr)  (memory_management_struct.pages_struct + (Virt_To_Phy(kaddr) >> PAGE_2M_SHIHF))
#define Phy_To_2M_Page(kaddr)  (memory_management_struct.pages_struct + ((unsigned long)(kaddr) >> PAGE_2M_SHIHF))
...
#define PAGE_Global (unsigned long)0x1000
...
#define mk_papt(addr,attr)  ((unsigned long)(addr)  |   (unsigned long)(attr))
