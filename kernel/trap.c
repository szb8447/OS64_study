...
void do_debug(unsigned long rsp, unsigned long error_code)
{
    unsigned long* p = NULL;
    p = (unsigned long*)(rsp + 0x98);
    color_printk(RED, BLACK, "do_debug(1),ERROR_CODE:%#0181x,RSP:%#0181x,RIP:%#0181x\n", error_code, rsp, *p);
    while (1);
...
void do_int3(unsigned long rsp, unsigned long error_code)
{
    unsigned long* p = NULL;
    p = (unsigned long*)(rsp + 0x98);
    color_printk(RED, BLACK, "do_int3(3),ERROR_CODE:%#0181x,RSP:%#0181x,RIP:%#0181x\n", error_code, rsp, *p);
    while (1);
...
void do_overflow(unsigned long rsp, unsigned long error_code)
{
    unsigned long* p = NULL;
    p = (unsigned long*)(rsp + 0x98);
    color_printk(RED, BLACK, "do_overflow(4),ERROR_CODE:%#0181x,RSP:%#0181x,RIP:%#0181x\n", error_code, rsp, *p);
    while (1);
...
void do_bounds(unsigned long rsp, unsigned long error_code)
{
    unsigned long* p = NULL;
    p = (unsigned long*)(rsp + 0x98);
    color_printk(RED, BLACK, "do_bounds(5),ERROR_CODE:%#0181x,RSP:%#0181x,RIP:%#0181x\n", error_code, rsp, *p);
    while (1);
...
void do_undefined_opcode(unsigned long rsp, unsigned long error_code)
{
    unsigned long* p = NULL;
    p = (unsigned long*)(rsp + 0x98);
    color_printk(RED, BLACK, "do_undefined_opcode(6),ERROR_CODE:%#0181x,RSP:%#0181x,RIP:%#0181x\n", error_code, rsp, *p);
    while (1);
...
void do_dev_not_available(unsigned long rsp, unsigned long error_code)
{
    unsigned long* p = NULL;
    p = (unsigned long*)(rsp + 0x98);
    color_printk(RED, BLACK, "do_dev_not_available(7),ERROR_CODE:%#0181x,RSP:%#0181x,RIP:%#0181x\n", error_code, rsp, *p);
    while (1);
...
void do_double_fault(unsigned long rsp, unsigned long error_code)
{
    unsigned long* p = NULL;
    p = (unsigned long*)(rsp + 0x98);
    color_printk(RED, BLACK, "do_double_fault(8),ERROR_CODE:%#0181x,RSP:%#0181x,RIP:%#0181x\n", error_code, rsp, *p);
    while (1);
...
void do_coprocessor_segment_overrun(unsigned long rsp, unsigned long error_code)
{
    unsigned long* p = NULL;
    p = (unsigned long*)(rsp + 0x98);
    color_printk(RED, BLACK, "do_coprocessor_segment_overrun(9),ERROR_CODE:%#0181x,RSP:%#0181x,RIP:%#0181x\n", error_code, rsp, *p);
    while (1);
...
void do_invalid_TSS(unsigned long rsp, unsigned long error_code)
{
    ...
    if(error_code & 0x01)
    {
        color_printk(RED, BLACK, "The exception occurred during delivery of an event external to the program,sunch as an interrupt or an earlier exception;\n");

    }

    if(error_code & 0x02)
    {
        color_printk(RED,BLACK,"Refers to a gate description in the IDT;\n");
    }
    else
    {
...
void do_segment_not_present(unsigned long rsp, unsigned long error_code)
{
    unsigned long* p = NULL;
    p = (unsigned long*)(rsp + 0x98);
    color_printk(RED, BLACK, "do_segment_not_present(11),ERROR_CODE:%#0181x,RSP:%#0181x,RIP:%#0181x\n", error_code, rsp, *p);
...
void do_stack_segment_fault(unsigned long rsp, unsigned long error_code)
{
    unsigned long* p = NULL;
    p = (unsigned long*)(rsp + 0x98);
    color_printk(RED, BLACK, "do_stack_segment_fault(12),ERROR_CODE:%#0181x,RSP:%#0181x,RIP:%#0181x\n", error_code, rsp, *p);
...
void do_general_protection(unsigned long rsp, unsigned long error_code)
{
    unsigned long* p = NULL;
    p = (unsigned long*)(rsp + 0x98);
    color_printk(RED, BLACK, "do_general_protection(13),ERROR_CODE:%#0181x,RSP:%#0181x,RIP:%#0181x\n", error_code, rsp, *p);
...
void do_x87_FPU_error(unsigned long rsp, unsigned long error_code)
{
    unsigned long* p = NULL;
    p = (unsigned long*)(rsp + 0x98);
    color_printk(RED, BLACK, "do_x87_FPU_error(16),ERROR_CODE:%#0181x,RSP:%#0181x,RIP:%#0181x\n", error_code, rsp, *p);
    while (1);
...
void do_alignment_check(unsigned long rsp, unsigned long error_code)
{
    unsigned long* p = NULL;
    p = (unsigned long*)(rsp + 0x98);
    color_printk(RED, BLACK, "do_alignment_check(17),ERROR_CODE:%#0181x,RSP:%#0181x,RIP:%#0181x\n", error_code, rsp, *p);
    while (1);
...
void do_machine_check(unsigned long rsp, unsigned long error_code)
{
    unsigned long* p = NULL;
    p = (unsigned long*)(rsp + 0x98);
    color_printk(RED, BLACK, "do_machine_check(18),ERROR_CODE:%#0181x,RSP:%#0181x,RIP:%#0181x\n", error_code, rsp, *p);
    while (1);
...
void do_SIMD_exception(unsigned long rsp, unsigned long error_code)
{
    unsigned long* p = NULL;
    p = (unsigned long*)(rsp + 0x98);
    color_printk(RED, BLACK, "do_SIMD_exception(19),ERROR_CODE:%#0181x,RSP:%#0181x,RIP:%#0181x\n", error_code, rsp, *p);
    while (1);
...
void do_virtualization_exception(unsigned long rsp, unsigned long error_code)
{
    unsigned long* p = NULL;
    p = (unsigned long*)(rsp + 0x98);
    color_printk(RED, BLACK, "do_virtualization_exception(20),ERROR_CODE:%#0181x,RSP:%#0181x,RIP:%#0181x\n", error_code, rsp, *p);
    while (1);
